...
class ContactHelper:
    ...
    def fill_contact_form(self, contact):
        ...
        Select(wd.find_element_by_name("aday")).select_by_visible_text(contact.aniv_day)
        wd.find_element_by_xpath("(//option[@value='13'])[2]").click()
        wd.find_element_by_name("amonth").click()
        Select(wd.find_element_by_name("amonth")).select_by_visible_text(contact.aniv_month)
        wd.find_element_by_xpath("(//option[@value='June'])[2]").click()
        wd.find_element_by_name("ayear").click()
        wd.find_element_by_name("ayear").clear()
        wd.find_element_by_name("ayear").send_keys(contact.aniv_year)
